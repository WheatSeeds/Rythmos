...
const FilterDropdown = ({
  ...
  return (
    <>
      {visible ? <div id="filter-dropdown-background"></div> : <></>}
      <div id="filter-dropdown">
        ...
        />
        <div
          className={visible ? "filter-dropdown-visible" : "filter-dropdown"}
        >
          <section>
            <span className="filter-category-title">Brands</span>
            <div
              id="filter-dropdown-brands-checkbox"
              className={viewAll ? "view-all" : ""}
            >
              {brands.map((brand) => (
                <FilterCheckbox
            ...
            <button
              className="filter-dropdown-view-all-btn"
